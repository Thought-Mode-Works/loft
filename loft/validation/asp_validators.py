...
class ASPSyntaxValidator:
    ...
    def validate_generated_rule(
        self, rule_text: str, existing_predicates: Optional[List[str]] = None
    ) -> ValidationResult:
        """
        ...
        including syntax, naming conventions, and structural checks.

        Args:
            rule_text: The ASP rule to validate
            existing_predicates: Optional list of existing predicates (e.g., ["contract/1", "party/2"])
