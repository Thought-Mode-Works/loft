...
# Create PR with a robust description, including "generated by gemini"
gh pr create --title "feat(module): description (#XXX)" --body "A detailed description of the changes, their impact, and any relevant context. Generated by Gemini."
```
