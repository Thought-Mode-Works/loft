...
def demonstrate_comprehensive_system():
    ...
    print(f"  ✓ Rules generated with varying confidence scores (0.70-0.90)")
    print(f"  ✓ {result1.rules_incorporated} rules incorporated in first cycle")
    print(f"  ✓ Duplicate detection prevented re-incorporation")
    print(f"  ✓ Rules persisted with metadata (timestamp, cycle, confidence)")
